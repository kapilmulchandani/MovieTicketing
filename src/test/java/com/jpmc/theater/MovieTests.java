...
public class MovieTests {
    ...
    void specialMovieWith50PercentDiscount() {
        Movie spiderMan = new Movie("Spider-Man: No Way Home", "With great power comes great responsibility.",Duration.ofMinutes(90),12.5, 1);
    ...
    void firstShowSequenceWithThreeDollarDiscount() {
        Movie spiderMan = new Movie("Spider-Man: No Way Home", "With great power comes great responsibility.", Duration.ofMinutes(90),12.5, 0);
    ...
    void showBetween11and4With25PercentDiscount() {
        Movie spiderMan = new Movie("Spider-Man: No Way Home", "With great power comes great responsibility.", Duration.ofMinutes(90),10, 0);
    ...
    void showWithAllDiscountsGetsTheOneWithMaximumDiscount() {
        Movie spiderMan = new Movie("Spider-Man: No Way Home", "With great power comes great responsibility.", Duration.ofMinutes(90),10, 1);
